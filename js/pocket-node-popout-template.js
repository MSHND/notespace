...
<body class="${bodyClass}">
  <main class="wrap">
    <div class="topbar"><div class="toolbarGroup identity"><div class="brand">pocket editor <span class="dirty">*</span></div><span id="saveState" class="status" aria-live="polite"></span></div><div class="toolbarGroup actions" aria-label="Save actions"><button id="saveBtn" class="toolbarBtn" type="button"${disabledEditorControl}>save</button><button id="saveCloseBtn" class="toolbarBtn" type="button"${disabledEditorControl}>save &amp; close</button></div><div class="toolbarGroup mode" aria-label="Content sections"><button id="textModeBtn" type="button"${disabledEditorControl}>Notes</button><button id="outlineModeBtn" type="button"${disabledEditorControl}>Outline</button></div><div class="grow"></div><div class="toolbarHint">${toolbarHint}</div><button id="closeBtn" type="button" aria-label="Close editor">×</button></div>
    ...
    <div class="fields"><input id="titleInput" value="${safeTitle}" aria-label="Item name"${readOnlyFieldAttributes}><textarea id="bodyInput" aria-label="Notes"${readOnlyFieldAttributes}>${safeBody}</textarea><div id="outlinePane" class="outlinePane" aria-label="Outline"></div></div>
  </main>
