...
(function () {
  ...
  function setMode(nextMode) { mode = nextMode === "outline" ? "outline" : "text"; updateModeChrome(); if (mode === "outline") renderOutline(0); else bodyInput.focus({ preventScroll: true }); storeDraft(); }
