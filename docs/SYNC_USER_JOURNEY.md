...
This is the approved human journey for a future Synced Pocket. P027-P041 do not add these screens or turn sync on. There is no production account, passkey UI, emergency-recovery UI, device transfer or deployed remote service yet. P039/P040 prove activation ordering and authority transition through injected dormant seams. P041 proves emergency recovery up to a durable non-authoritative state, including safe pause/resume until the replacement recovery copy is stored. It changes no approved copy.
