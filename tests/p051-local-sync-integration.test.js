...
test("P054 local integration is inert until create and returns only explicit provider-neutral recovery operations", async () => {
  ...
  assert.deepEqual(Object.keys(integration), ["activate", "resume", "openExisting", "captureSwitchTarget", "saveSwitchTarget", "discardSwitchTarget", "recoverExisting", "resumeRecovery", "findRecoveryAttempt", "verifyRoundTrip"]);
