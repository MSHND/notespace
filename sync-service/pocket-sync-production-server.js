...
function createProductionServer(input) {
  if (!input || typeof input !== "object" || Array.isArray(input)
      ...
      || Object.keys(input).some((key) => !["application", "browserRoot", "serviceRoot", "listen", "http"].includes(key))
      || !input.application || typeof input.application.handle !== "function"
      ...
      || (input.http !== undefined && (!input.http || typeof input.http.createServer !== "function"))) throw productionError();
